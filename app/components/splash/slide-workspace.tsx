...
// Four products — shown one at a time, each in a fresh spot.
const PRODUCTS = ["macbook.png", "iphone17.png", "tab.png", "headset.png"];
...
const POSITIONS: { left: string; top: string; size: number }[] = [
  { left: "30%", top: "40%", size: 320 },
  { left: "70%", top: "36%", size: 300 },
  { left: "48%", top: "58%", size: 330 },
  { left: "24%", top: "62%", size: 300 },
  { left: "74%", top: "60%", size: 300 },
  { left: "52%", top: "38%", size: 310 },
];
    ...
    <div className="relative z-10 flex h-full flex-col px-10 pb-20 pt-24 text-center">
      <motion.div variants={headerStagger} initial="hidden" animate="show">
        <motion.h2 variants={rise} className="text-h1 font-extrabold leading-[1.05] text-ash-950">
          Built for Your
          <br />
          <span className="gradient-text-brand">Workday</span>
        </motion.h2>
      </motion.div>
        ...
        <AnimatePresence>
          ...
          >
            <div className="relative h-full w-full">
              <Image
                src={`/images/splash6/${PRODUCTS[state.product]}`}
                alt=""
                fill
                sizes="330px"
