...
// Six products — shown one at a time, each in a fresh spot.
const PRODUCTS = [
  "microwave.png",
  "coffee-machine.png",
  "air-fryer.png",
...
export default function SlideHomeKitchen() {
    ...
    <div className="relative z-10 flex h-full flex-col px-10 pb-20 pt-24 text-center">
      <motion.div variants={headerStagger} initial="hidden" animate="show">
        <motion.h2 variants={rise} className="text-h1 font-extrabold leading-[1.05] text-ash-950">
          Everything for Your
          <br />
          <span className="gradient-text-brand">Home &amp; Kitchen</span>
        </motion.h2>
      </motion.div>
        ...
        <AnimatePresence>
          ...
          >
            <div className="relative h-full w-full">
              <Image
                src={`/images/splash4/${PRODUCTS[state.product]}`}
                alt=""
                fill
                sizes="330px"
