...
export default function OnScreenKeyboard({
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-0 left-1/2 z-50 w-[1080px] -translate-x-1/2 rounded-t-[40px] border-t border-line bg-keyboard px-8 pb-10 pt-6 shadow-[0_-16px_48px_rgba(0,0,0,0.18)]"
    >
